...
hg forget SpotIT/.gradle/**
hg forget SpotIT/.idea/**

hg forget SpotIT/app/build/**
hg forget SpotIT/app/src/androidTest/**
hg forget SpotIT/app/src/debug/**
hg forget SpotIT/app/src/release/**
hg forget SpotIT/app/src/test/**
hg forget SpotIT/app/app.iml
hg forget SpotIT/app/google-services.json
hg forget SpotIT/app/proguard-rules.pro

hg forget SpotIT/build/**
hg forget SpotIT/gradle/**

hg forget SpotIT/build.gradle
hg forget SpotIT/gradle.properties
hg forget SpotIT/gradlew
hg forget SpotIT/gradlew.bat
